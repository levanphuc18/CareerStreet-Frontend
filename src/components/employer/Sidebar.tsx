...
export default function HomePage() {
  ...
  return (
    <>
        {/* Sidebar */}
        <div className="hidden h-screen md:flex flex-col w-64 bg-gray-800 shadow-lg">
          <Link
            href="/employer/home"
          ...
          <div className="flex flex-col flex-1 overflow-y-auto">
            <nav className="flex-1 px-2 py-4 bg-gray-800">
              {/* Nhóm chức năng */}
              <h2 className="text-gray-400 px-4 text-center">Chức Năng</h2>
              ...
              <div>
                ...
                {isJobsDropdownOpen && (
                  <div className="pl-4">
                    ...
                    >
                      <span>Công việc của tôi</span>
                    </Link>
                    <Link
                      href="/employer/jobs/add"
                      className="flex items-center px-4 py-2 mt-2 text-gray-100 hover:bg-gray-700 rounded-lg"
                    >
                      <span>Đăng tin tuyển dụng</span>
                    </Link>
                  </div>
                )}
              </div>
